...
export class App extends LitElement {
  ...
  async showHelpToast() {
    const { showSnackbar } = await import("./util/show-snackbar.js");
    showSnackbar(
      `Web Skills is an overview of useful skills to learn as a web developer`,
      {
        timeout: 1000 * 20,
        wide: true,
        buttons: [
  ...
  toggleCompact(e) {
    ...
    history.replaceState(
      null,
      "",
      search.length === 0 ? location.pathname : `${location.pathname}?${search}`
    );
  }
  ...
  focusCollection(name) {
    const $anchor = this.shadowRoot.querySelector(
      `.focus-anchor[data-collection="${getId({ name })}"]`
    );
    if ($anchor != null) {
      $anchor.focus();
  ...
  focusNavigationSelect() {
    const $navigationSelection =
      this.shadowRoot.querySelector("#navigation-select");
  ...
  render() {
    ...
    return html`
      <div id="skip-navigation">
        <div>
          ...
          <select
            ...
            @input="${(e) => this.focusCollection(e.target.value)}"
      ...
      <header id="header">
        <div>
          <a
            href="https://github.com/andreasbm/web-skills"
            target="_blank"
            rel="noopener"
        ...
        <div>
          <div
            id="toggle-compact"
            title="${this.compact ? `Disable` : `Enable`} compact layout"
          >
            <ws-compact-switch
              @toggle="${this.toggleCompact}"
          ...
          <a
            ...
            href="https://andreasbm.github.io"
            target="_blank"
            rel="noopener"
            title="Say hi"
          >
          ...
          <a
            ...
            href="https://www.buymeacoffee.com/AndreasMehlsen"
            rel="noopener"
            title="Support me <3"
            target="_blank"
          >
            ...
            >
              ...
              >
                <path
                  d="M119.563 265.584c-27-20.344-43.822-41.277-50.465-62.8-6.643-21.522-7.9-45.48-3.771-71.875M170.152 189.86c12.91-24.089 19.139-47.393 18.685-69.913-.453-22.52-5.297-42.502-14.53-59.947"
                />
              </g>
            </svg>
      ...
      <main id="collections">
        ${repeat(
          ...
          (collection, i) => html`
            <span
              class="focus-anchor"
              data-collection="${getId(collection)}"
              tabindex="0"
            ></span>
            <ws-collection
              class="collection"
      ...
      <footer id="footer">
        <div>
          ${user != null
            ? html` <ws-button @click="${signOut}">🔓 Sign out</ws-button> `
            : html`
                <ws-button @click="${signIn}">🔒 Sign in with Google</ws-button>
              `}
          <a
            href="https://github.com/andreasbm/web-skills/stargazers"
            target="_blank"
            aria-label="Become a stargazer"
            rel="noopener"
          >
            <ws-button>⭐️ Become a stargazer</ws-button>
          </a>
          <a
            href="https://twitter.com/AndreasMehlsen"
            target="_blank"
